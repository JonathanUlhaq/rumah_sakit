...
class FormBpjs extends BaseController
{
    ...
    {
        $data = [
            'tittle' => 'RSU Magetan | Formulir Pasien BPJS',
            'validation' => \Config\Services::validation(),
            'poli' => $this->dataSpesialis->findAll(),

        ];
        return view('FormBpjs/create', $data);
    }
    ...
    public function tambah()
    {
        if (!$this->validate([
            ...
            return redirect()->to('/FormBpjs/create')->withInput()->with('validation', $validation);
        };
        $random = rand(1, 500);
        ...
        $this->dataAntrian->insert($antri);



        session()->setFlashdata('yes', 'Data berhasil ditambah');
        return redirect()->to('/FormBpjs/tiket');
    }
    ...
    public function tiket()
    {
        ...
        return view('FormBpjs/tiket', $data);
    }
    ...
    public function print()
    {
        ...
        return view('FormBpjs/print', $data);
    ...
    public function printpdf()
    {
        ...
        $cetak = view('FormBpjs/print', $data);
