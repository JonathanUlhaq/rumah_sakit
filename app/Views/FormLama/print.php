        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                <div class="card-body text-center ">
                    <p style="font-size: 20px;"> Nomor RM : <?= $nama['nomor_rm']; ?> </p>
                    <div class="text-center " style="text-align: center;">
                        <h2>RUMAH SAKIT UMUM MAGETAN</h2>
                        <br>
                        <h4>Jl. Pahlawan No. 14, Magetan, Jawa Timur</h5>
                            <h5>Website : http://rsumagetan.gov.id</h5>
                            <hr>
                            <p style="font-size: 35px;"> Estimasi Waktu Pelayanan :</p>
                            <p style="font-size: 30px;"> <?= $antrian['estimasi_waktu']; ?> </p>
                            <p style="font-size: 15px;"> <strong>Mohon hadir 15 menit sebelum waktu yang ditentukan</strong> </p>
                            <h3>Nomor Antrian</h3>
                            <h1 style="font-size: 100px;"><strong><?= $antrian['nomor_antrian']; ?></strong></h1>
                            <h2 style="font-size: 50px;"><strong><?= $nama['nama_pasien']; ?></strong></h2>
                            <?php if ($nama['nomor_bpjs'] == true) { ?>
                                <h2 style="font-size: 25px;">Nomor BPJS : <strong><?= $nama['nomor_bpjs']; ?></strong></h2>
                            <?php } ?>
                            <p style="font-size: 20px;"> Tanggal Pengambilan : <?= $antrian['tanggal_berobat']; ?> </p>
