                ...
                <div class="card-body text-center ">
                    ...
                    <div class="text-center " style="text-align: center;">
                        ...
                        <h4>Jl. Pahlawan No. 14, Magetan, Jawa Timur</h5>
                            ...
                            <hr><br>
                            <p style="font-size: 35px;"> Estimasi Waktu Pelayanan :</p><br>
                            <p style="font-size: 30px;"> <?= $antrian['estimasi_waktu']; ?> </p><br><br>
                            <h3>Nomor Antrian</h3>
                            <h1 style="font-size: 100px;"><strong><?= $antrian['nomor_antrian']; ?></strong></h1>
                            <h2 style="font-size: 50px;"><strong><?= $antrian['nama_pasien']; ?></strong></h2><br><br><br>
                            ...
                            <br><br><br>
                            <a href="/print" class="btn btn--radius btn--green">Cetak</a>
