...
<link rel="apple-touch-icon" href="<?= base_url() ?>/images/icon/apple-touch-icon.png">
    ...
    <div class="container">
        <div class="footer-distributed">
            <div class="footer-left">
                <p class="footer-company-name">@ Sistem Informasi Rumah Sakit Umum Magetan </p>
            </div>
